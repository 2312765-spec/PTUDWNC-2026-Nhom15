...
**Tiến độ:** 2 / 34 FR xong hẳn (6%), 1 🟡 đang làm (FR-CAT-001: build + unit + architecture
+ smoke test xanh; integration test `GetCategoriesTests.cs` cần Testcontainers, chưa chạy
được ở môi trường sửa PR này) — A 2/8 · B 0/11 (1 🟡) · C 0/7 · D 0/8
